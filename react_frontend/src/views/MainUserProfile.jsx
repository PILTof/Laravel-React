...
import DefaultAvatar from "../assets/avatars/AvatarPlaceholder.jpg";
...
import FileUpload from "./comp/DragAndDrop";
...
export default function MainUserProfile(props) {
    ...
    const onSubmit = (ev) => {
        ...
        if (name == "") {
            ...
            if (avatarImage !== null) {
                ...
                fdata.append("avatar_img", avatarImage);
                console.log(fdata);
                axiosClient
                    .post(`/updateuser/${id}`, fdata)
                    .then((res) => {
                        console.log(res);
                        getActiveUser();
                        setManageOpen(false);
    ...
    const onAvatarChange = (ev) => {
        ...
        setAvatarImage(ev.target.files[0]);
    };
                    ...
                    {!manageOpen ? (
                        <img
                            ...
                            src={
                                activeUser === null
                                    ? DefaultAvatar
                                    : (activeUser.data.filepath === null ? DefaultAvatar : url + activeUser.data.filepath) 
                            }
                            alt=""
                        />
                    ) : (
            ...
            <div style={{ backgroundColor: "#3B3B3B" }}>
                {activeTab == 1 && !manageOpen ? (
                    <ProfileCards
                        ...
                        name={activeUser === null ? null : activeUser.data.name}
                        profile_img={activeUser === null ? null : activeUser.data.filepath}
                    ></ProfileCards>
                ) : null}
            </div>
        </div>
