...
class PostsController extends Controller
{
    ...
    public function createPost(PostsRequest $request)
    {
        ...
        $file_new_name = $this->generateRandomString(20) . '_' . 'nft_image_'.$request['label'];
    ...
    {
        $image = DB::table('posts_models')->where('id', $id)->get('file_name');
        $filepath = public_path() . '/storage/uploads/' . $image[0]->file_name;
        unlink($filepath);
